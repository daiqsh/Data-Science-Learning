...
class SplitEmail:
    ...
    def splitsingle(self, trie, email):
        ...
        self.search_in_trie(chars, trie, res)
        res = list(set(res))
        # for splitword in res:
        #     try:
        #         #print splitword.decode('utf-8').encode('gb2312')
        #         #print splitword
        #     except :
        #         #print splitword
        return res
...
def test():
    ...
    demo.ratio = demo.getRatio()
    dirpath = './datatest/normal/'
    count=1
    for fn in os.listdir(dirpath):
        ...
        if os.path.exists(path):
            ...
            try:
                ...
                string = content.decode('gbk','ignore')
                #string = content
        P = analysisEmail.JudgeMail().judge(demo, trie, string)
        if(P>0.9):
            print count, " : ", P
            count = count +1
